...
import com.example.marinello.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbarAddNewOrders);
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull @NotNull AdminOrdersViewHolder holder, int i, @NonNull @NotNull AdminOrders model) {
                        holder.userName.setText("Nome: " + model.getName());
                        holder.userPhoneNumber.setText("Telefono: " + model.getPhone());
                        holder.userTotalPrice.setText("Prezzo totale: " + model.getTotalAmount());
                        holder.userDateTime.setText("Data: " + model.getDate() + " "+model.getTime());
                        holder.userShippingAddress.setText("Indirizzo: " + model.getAddress()+"," + model.getCity());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setTitle("Hai spedito i prodotti di quest ordine?");
